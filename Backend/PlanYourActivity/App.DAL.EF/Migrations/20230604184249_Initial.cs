    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Hex = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockedAppUserId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColourId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Events_Colours_ColourId",
                        column: x => x.ColourId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteUser_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JoiningLocked = table.Column<bool>(type: "boolean", nullable: false),
                    AdminId = table.Column<Guid>(type: "uuid", nullable: false),
                    GroupGenderId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Groups_Genders_GroupGenderId",
                        column: x => x.GroupGenderId,
                        principalTable: "Genders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AvailableForGroupEvent = table.Column<bool>(type: "boolean", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventInGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventInGroups_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventInGroups_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InviteToGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InviteToGroups_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InviteToGroups_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserInGroups_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Question = table.Column<string>(type: "character varying(244)", maxLength: 244, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PollQuestions_UserInGroups_CreatorId",
                        column: x => x.CreatorId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Option = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserInGroupId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOptionChoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserOptionChoices_PollOptions_PollOptionId",
                        column: x => x.PollOptionId,
                        principalTable: "PollOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserOptionChoices_UserInGroups_UserInGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventInGroups_EventId",
                table: "EventInGroups",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventInGroups_GroupId",
                table: "EventInGroups",
                column: "GroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteUser_AppUserId",
                table: "FavoriteUser",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_GroupGenderId",
                table: "Groups",
                column: "GroupGenderId");

            migrationBuilder.CreateIndex(
                name: "IX_InviteToGroups_AppUserId",
                table: "InviteToGroups",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InviteToGroups_GroupId",
                table: "InviteToGroups",
                column: "GroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PollQuestions_CreatorId",
                table: "PollQuestions",
                column: "CreatorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInGroups_AppUserId",
                table: "UserInGroups",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOptionChoices_PollOptionId",
                table: "UserOptionChoices",
                column: "PollOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserOptionChoices_UserInGroupId",
                table: "UserOptionChoices",
